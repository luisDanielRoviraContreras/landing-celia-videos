...
// Fondo Grainient (ogl WebGL). Gradiente animado con grano.
// Por defecto: gris muy sutil (casi imperceptible) sobre fondo oscuro.
const props = defineProps({
  timeSpeed: { type: Number, default: 0.16 },
  colorBalance: { type: Number, default: 0.0 },
  warpStrength: { type: Number, default: 1.0 },
  warpFrequency: { type: Number, default: 4.0 },
  warpSpeed: { type: Number, default: 1.4 },
  warpAmplitude: { type: Number, default: 60.0 },
  blendAngle: { type: Number, default: 0.0 },
  blendSoftness: { type: Number, default: 0.12 },
  rotationAmount: { type: Number, default: 360.0 },
  noiseScale: { type: Number, default: 2.0 },
  grainAmount: { type: Number, default: 0.04 },
  ...
  saturation: { type: Number, default: 0.6 },
  centerX: { type: Number, default: 0.0 },
  centerY: { type: Number, default: 0.0 },
  zoom: { type: Number, default: 0.9 },
  // gris limpio y suave
  color1: { type: String, default: '#26262c' },
  color2: { type: String, default: '#15151a' },
  color3: { type: String, default: '#0b0b0e' },
})
...
<template>
  <div ref="containerRef" class="grainient"></div>
</template>
